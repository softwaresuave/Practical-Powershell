<#
.DESCRIPTION
	SYSADMIN TOOLKIT. INCLUDES A VARIETY OF ACTIVE DIRECTORY FUNCTIONS TO RUN ON DOMAIN CONTROLLER.
.AUTHOR
	TYLER NEELY
.LASTMOD
	2/18/2022
...
Write-Host ' 2 - REPLICATE ALL DOMAIN CONTROLLERS'
Write-Host ' 3 - SHOW DEFAULT DOMAIN POLICY'
Write-Host ' 4 - LIST OF ALL ACTIVE GPOS'
Write-Host ' 5 - LIST ALL MACHINES ON DOMAIN'
Write-Host ' 6 - MOVE COMPUTER TO OU'
Write-Host ' 7 - LIST USERS GROUPS'
Write-Host ' 8 - LIST USERS PROPERTIES'
Write-Host ' 9 - LIST USERS LAST LOGIN'
Write-Host '10 - FIND NEGLECTED USER | COMPUTER ACCOUNTS'
Write-Host '11 - DISABLE AD USER | OFFBOARDING'
Write-Host '12 - ADD MAC TO DHCP FILTER'
